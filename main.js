...
widndow.addEventListener("keydown", my_keydown);
...
function my_keydown(e)
{
	...
	console.log(keyPressed);
	 ...
	 {
		 alphabethkey();
		 document.getElementById("d1").innerHTML="You pressed Alphabeth Key";
		 console.log("alphabeth key")
		...
		specialkey();
		document.getElementById("d1").innerHTML="You pressed Ctrl Alt or Esc Key";
